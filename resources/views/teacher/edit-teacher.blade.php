                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text"
                                                ...
                                                name="full_name" placeholder="Enter Name" value="{{ $teacher->full_name }}">
                                            @error('full_name')
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select  @error('gender') is-invalid @enderror"
                                                ...
                                                <option value="Female"
                                                    {{ $teacher->gender == 'Female' ? 'selected' : 'Female' }}>Female
                                                </option>
                                                <option value="Male" {{ $teacher->gender == 'Male' ? 'selected' : '' }}>
                                                    Male</option>
                                                <option value="Others" {{ $teacher->gender == 'Others' ? 'selected' : '' }}>
                                                    Others</option>
                                            </select>
                                            @error('gender')
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control @error('mobile') is-invalid @enderror"
                                                name="mobile" placeholder="Enter Phone" value="{{ $teacher->mobile }}">
                                            @error('mobile')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="email"
                                                ...
                                                placeholder="Enter Mail Id" value="{{ $teacher->email }}" readonly>
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="password"
                                                ...
                                                name="password" placeholder="Enter Password" value="******" readonly>
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="password"
                                                ...
                                                name="password_confirmation" placeholder="Repeat Password" value="*****"
                                                readonly>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Enter City" value="{{ $teacher->city }}">
                                            @error('city')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Enter State" value="{{ $teacher->state }}">
                                            @error('state')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text"
                                                ...
                                                name="zip_code" placeholder="Enter Zip"
