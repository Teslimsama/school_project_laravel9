                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('teacher/list/page') }}" class="btn btn-outline-gray me-2"><i
                                                class="feather-list"></i></a>
                                        <a href="{{ route('teacher/grid/page') }}"
                                            class="btn btn-outline-gray me-2 active"><i class="feather-grid "></i></a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="student-box flex-fill">
                                                        ...
                                                        <div class="student-content pb-0">
                                                            <h5><a
                                                                    href="{{ url('teacher/profile/' . $list->id) }}">{{ $list->full_name }}</a>
                                                            </h5>
                                                            <h6>Teacher</h6>
                                                        </div>
                                                    </div>
